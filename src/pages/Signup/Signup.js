                ...
                <div className='w-96 shadow-xl px-6 py-8 rounded-lg'>
                    ...
                    <form >
                        ...
                        <div className="form-control w-full  mb-2">
                            ...
                            <input
                                {...register("name", { required: "6 DIGIT" })} className="input input-bordered w-full " type="text" />

                            {errors.name && <p className='text-primary' role="alert">{errors.name?.message}</p>}
                        </div>
                        ...
                        <div className="form-control w-full  mb-2">
                            ...
                            {errors.Username && <p className='text-primary' role="alert">{errors.Username?.message}</p>}
                        </div>
